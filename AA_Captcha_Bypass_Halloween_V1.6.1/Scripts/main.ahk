...
main := Gui("+AlwaysOnTop", "Halloween Macro V1.6.1")
...
if !FileExist("..\Settings\settings.ini") {
    ...
    IniWrite("0", "..\Settings\settings.ini", "Checks", "Checkbox1")
    IniWrite("0", "..\Settings\settings.ini", "Checks", "Checkbox2")
    IniWrite("0", "..\Settings\settings.ini", "Checks", "Checkbox3")
    IniWrite("0", "..\Settings\settings.ini", "Checks", "Checkbox4")
    IniWrite("0", "..\Settings\settings.ini", "Checks", "Checkbox5")
    IniWrite("0", "..\Settings\settings.ini", "Checks", "Checkbox6")

    IniWrite("0", "..\Settings\settings.ini", "Dropdowns", "Dropdown1")
    IniWrite("0", "..\Settings\settings.ini", "Dropdowns", "Dropdown2")
    IniWrite("0", "..\Settings\settings.ini", "Dropdowns", "Dropdown3")
    IniWrite("0", "..\Settings\settings.ini", "Dropdowns", "Dropdown4")
    IniWrite("0", "..\Settings\settings.ini", "Dropdowns", "Dropdown5")
    IniWrite("0", "..\Settings\settings.ini", "Dropdowns", "Dropdown6")
}

Checkbox1.Value := IniRead("..\Settings\settings.ini", "Checks", "Checkbox1")
Checkbox2.Value := IniRead("..\Settings\settings.ini", "Checks", "Checkbox2")
Checkbox3.Value := IniRead("..\Settings\settings.ini", "Checks", "Checkbox3")
Checkbox4.Value := IniRead("..\Settings\settings.ini", "Checks", "Checkbox4")
Checkbox5.Value := IniRead("..\Settings\settings.ini", "Checks", "Checkbox5")
Checkbox6.Value := IniRead("..\Settings\settings.ini", "Checks", "Checkbox6")

Dropdown1.Value := IniRead("..\Settings\settings.ini", "Dropdowns", "Dropdown1")
Dropdown2.Value := IniRead("..\Settings\settings.ini", "Dropdowns", "Dropdown2")
Dropdown3.Value := IniRead("..\Settings\settings.ini", "Dropdowns", "Dropdown3")
Dropdown4.Value := IniRead("..\Settings\settings.ini", "Dropdowns", "Dropdown4")
Dropdown5.Value := IniRead("..\Settings\settings.ini", "Dropdowns", "Dropdown5")
Dropdown6.Value := IniRead("..\Settings\settings.ini", "Dropdowns", "Dropdown6")
...
Unit_GUI_Save() 
{
    ...
    IniWrite(Checkbox1.Value, "..\Settings\settings.ini", "Checks", "Checkbox1")
    IniWrite(Checkbox2.Value, "..\Settings\settings.ini", "Checks", "Checkbox2")
    IniWrite(Checkbox3.Value, "..\Settings\settings.ini", "Checks", "Checkbox3")
    IniWrite(Checkbox4.Value, "..\Settings\settings.ini", "Checks", "Checkbox4")
    IniWrite(Checkbox5.Value, "..\Settings\settings.ini", "Checks", "Checkbox5")
    IniWrite(Checkbox6.Value, "..\Settings\settings.ini", "Checks", "Checkbox6")

    IniWrite(Dropdown1.Value, "..\Settings\settings.ini", "Dropdowns", "Dropdown1")
    IniWrite(Dropdown2.Value, "..\Settings\settings.ini", "Dropdowns", "Dropdown2")
    IniWrite(Dropdown3.Value, "..\Settings\settings.ini", "Dropdowns", "Dropdown3")
    IniWrite(Dropdown4.Value, "..\Settings\settings.ini", "Dropdowns", "Dropdown4")
    IniWrite(Dropdown5.Value, "..\Settings\settings.ini", "Dropdowns", "Dropdown5")
    IniWrite(Dropdown6.Value, "..\Settings\settings.ini", "Dropdowns", "Dropdown6")
